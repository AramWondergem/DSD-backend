...
VALUES
    (1001, 'superuser', '$2a$10$DngToCGxdfBYmj9O2l01c.JtNfvKSBOqgYbuHlMLBf52f9s6wJO7u', 'superuser1@test.nl', 'Super User 1'),
    (1002, 'jdoe', '$2a$10$DngToCGxdfBYmj9O2l01c.JtNfvKSBOqgYbuHlMLBf52f9s6wJO7u', 'jdoe@test.nl', 'John Doe'),
    (1003, 'asmith', '$2a$10$DngToCGxdfBYmj9O2l01c.JtNfvKSBOqgYbuHlMLBf52f9s6wJO7u', 'asmith@test.nl', 'Alice Smith'),
    (1004, 'bwilson', '$2a$10$DngToCGxdfBYmj9O2l01c.JtNfvKSBOqgYbuHlMLBf52f9s6wJO7u', 'bwilson@test.nl', 'Bob Wilson'),
    (1005, 'cmiller', '$2a$10$DngToCGxdfBYmj9O2l01c.JtNfvKSBOqgYbuHlMLBf52f9s6wJO7u', 'cmiller@test.nl', 'Charlie Miller'),
    (1006, 'djones', '$2a$10$DngToCGxdfBYmj9O2l01c.JtNfvKSBOqgYbuHlMLBf52f9s6wJO7u', 'djones@test.nl', 'David Jones'),
    (1007, 'ekim', '$2a$10$DngToCGxdfBYmj9O2l01c.JtNfvKSBOqgYbuHlMLBf52f9s6wJO7u', 'ekim@test.nl', 'Emily Kim'),
    (1008, 'fmurphy', '$2a$10$DngToCGxdfBYmj9O2l01c.JtNfvKSBOqgYbuHlMLBf52f9s6wJO7u', 'fmurphy@test.nl', 'Frank Murphy'),
...
INSERT INTO apartments (id, apartment_number,building_id) VALUES (1001,1,1001),
                                                                 (1002,2,1001),
                                                                 (1003,3,1001),
                                                                 (1004,4,1001),
                                                                 (1005,5,1001),
...
INSERT INTO parkings (id,number_of_guest_spots, number_of_tenant_spots, building_id) VALUES (1001 ,10, 80,1001);

INSERT INTO doors (id,door_status,building_id) VALUES (1001,'LOCKED',1001);

INSERT INTO doors (id,door_status,apartment_id) VALUES  (1002,'LOCKED',1001);

INSERT INTO doors (id,door_status,parking_id) VALUES (1003,'LOCKED',1001);

INSERT INTO tenants_apartments (user_id,apartment_id) VALUES (1001,1001),
                                                             (1002,1001),
                                                             (1003,1002),
                                                             (1004,1002),
                                                             (1005,1003),
...
INSERT INTO doors_users (user_id, door_id) VALUES (1001,1001);

INSERT INTO lockers (id, locker_number, building_id, apartment_id, update_date)
VALUES
    (1001, 101, 1001, NULL, '2025-03-19T10:00:00Z'),
