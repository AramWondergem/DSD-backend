...
public class LockerController {
    ...
    @Operation(
            summary = "NOT FUNCTIONAL YET: Updates a locker assignment",
    ...
    @Operation(
            summary = "NOT FUNCTIONAL YET: Retrieves all lockers in a building",
    ...
    @Operation(
            summary = "NOT FUNCTIONAL YET: Retrieves all lockers assigned to a user",
